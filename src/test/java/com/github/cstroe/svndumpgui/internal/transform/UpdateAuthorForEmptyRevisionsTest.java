...
public class UpdateAuthorForEmptyRevisionsTest {
    ...
    public void update_empty_revisions() throws ParseException {
        ...
        Repository dump = SvnDumpFileParserDoppelganger.consume("dumps/add_edit_delete_add.dump", dumpMutator);
        ...
        Repository updatedDump = SvnDumpFileParserDoppelganger.consume(dump, updateAuthor);
