...
public class UpdateAuthorForEmptyRevisionsTest {
    ...
    public void update_empty_revisions() throws ParseException {
        ...
        SvnDump dump = SvnDumpFileParserTest.consume("dumps/add_edit_delete_add.dump", dumpMutator);
        ...
        SvnDump updatedDump = SvnDumpFileParserTest.consume(dump, updateAuthor);
